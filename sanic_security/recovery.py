...
from sanic_security.models import TwoStepSession, AuthenticationSession
from sanic_security.utils import hash_password


async def recover_password(request: Request, two_step_session: TwoStepSession):
    """
    Changes an account's password once recovery request was determined to be made by the account owner
